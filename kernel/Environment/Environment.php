...
namespace Qwik\Kernel\Environment;

use Qwik\Kernel\App\AppManager;

class Environment extends \Qwik\Kernel\Config\Config{
    /**
    ...
    /**
     * @return \Qwik\Kernel\App\AppManager
     */
    ...
    private function load(){
        ...
        $config = new \Qwik\Kernel\App\Config();
